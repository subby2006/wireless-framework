...
// christian please actually properly format this
...
int potVal1 = 0; // read input from potentiometer1.
int potVal2 = 0; // read input from potentiometer2.
...
servo1.writeMicroseconds(pwmVal2); // Send signal to ESC2.
